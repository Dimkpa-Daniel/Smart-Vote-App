...
const Firstbody = () => {
    return (
       <div className="grid container1">
          ...
          <h1 class="display-6 disPlay">Vote Your Favourite <br/>
                Instructors <b>Here</b> </h1>

                <p class="h4 Ph1">Our design projects are fresh and simple and will <br/> 
                    benefit your business greatly. Learn more about our work!</p>

                    <Link to = "/LogIn" ><button type="button" class="btn btn-warning d-btn">VOTE NOW</button></Link>
                    <Link to = "/Register"><button type="button" class="btn btn-outline-secondary d-btn2">JOIN SMARTVOTE</button></Link>
...
<div className="row d-row">
              ...
              <p>Mr. Peter Akaliro <br /> is a Full Stack web developer. </p>
...
<div className="row d-row2">
              ...
              <div className="col-6 col-md-4 d-bio">
                <p>Mr. Peter Akaliro <br /> is a Full Stack web developer. 
                 </p>
